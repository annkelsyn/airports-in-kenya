...
map.getView().fit([2456000.001378, -941051.114628, 6625414.892757, 1062445.082286], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Airports in Kenya</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (220 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This Web Map visualizes airports and airstrips in Kenya.<br />Enables users to interact with their metadata via clickable symbols, zoom and pan functions.<br /><br />Coordinate reference system: EPSG 4326  WGS 84<br />Author: Annkelsy Nyaga';
            }
